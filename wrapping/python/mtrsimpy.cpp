...
PYBIND11_MODULE(mtrsim, m) {
  ...
  py::enum_<CrystalSystem>(m, "CrystalSystem")
      .value("HCP", CrystalSystem::HCP,
             "Hexagonal close-packed (12 symmetry operators)")
      .value("FCC", CrystalSystem::FCC,
             "Face-centred cubic (24 symmetry operators)")
      .export_values();
  ...
  // CrystalSymmetry
  // -------------------------------------------------------------------------
  py::class_<CrystalSymmetry>(
      m, "CrystalSymmetry",
      "Expands orientations to all crystallographically equivalent forms.")
      .def(py::init<CrystalSystem>(), "system"_a = CrystalSystem::HCP)
      .def("expand", &CrystalSymmetry::expand, "phi1"_a, "phi"_a, "phi2"_a,
           "Expand N orientations; returns [N*numOps x 3] matrix (phi1, PHI, "
           "phi2) [rad].")
      .def("num_operators", &CrystalSymmetry::numOperators,
           "Number of symmetry operators for the configured system.");
