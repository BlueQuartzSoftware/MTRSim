 ...
 * ODF ImageGeom to a MATLAB-format MTRSim ODF HDF5 file. Reverses the
 * (phi2=X, PHI=Y, phi1=Z) ImageGeom convention back to the phi1-first
...
public:
  ...
  static inline constexpr StringLiteral k_InputImageGeometry_Key = "input_image_geometry";
